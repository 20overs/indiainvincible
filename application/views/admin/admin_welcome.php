<div class="container-fluid margin-top-15">
	<span>Logged in as : <b><?=$this->session->userdata('admin_user_name')?></b></span>
	...
	<div class="container">
		...
		?>
			<div class="form-group">
		      ...
		      <input type="text" class="form-control form-control-cust" id="name" placeholder="Enter Title" name="title" value="<?php echo set_value('title'); ?>" required>
