	...
	var methods = {
		init : function( options ) { 
			...
			$(this).click(function(e) {
				...
				var url=t.attr('href');
				e.preventDefault();
				var div = $('<div></div>').addClass('light_container').html('<span class="light_inner"><div class="light_loading">'+settings.loadText+'</div></span><div class="light-title"></div><div class="light-desc"></div><a href="javascript:;" class="light_close">x</a>');
